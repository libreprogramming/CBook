...
\setmonofont[Courier]
\setmathfont[HelveticaLTStd-Light]
...
\definecolor[orchid][r=0,g=0,b=0]
...
any later version published by the Free Software Foundation. However,
modifications must pass through me and no forking is allowed. This is

...
\definetypeface[mainfacenormal]  [rm][serif] [times]       [default]
\definetypeface[mainfacenormal]  [ss][sans][times]    [default]
\definetypeface[mainfacenormal]  [tt][mono] [courier]      [default]
\definetypeface[mainfacenormal]  [mm][math] [times]       [default]

\definetypeface[mainfacemedium]  [rm][serif] [times][default]
\definetypeface[mainfacenormal]  [ss][sans][times]    [default]
\definetypeface[mainfacemedium]  [tt][mono] [courier]      [default]
\definetypeface[mainfacemedium]  [mm][math] [times][default]

\definetypeface[mainfacenarrowtt][tt][mono] [times] [default]

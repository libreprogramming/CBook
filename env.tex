...
{\starttable[|l|l|l|l| ]
\HL
\VL Data Type/Macro \VL Specified Value\VL \type{limits.h} value\VL Description\VL\SR
\HL
...
\HL
\stoptable}
\footnote[1]{I do not agree with 127 being equal to minimum value of a \type
{signed char}If we see 2's complement form then it should be -128. Please
